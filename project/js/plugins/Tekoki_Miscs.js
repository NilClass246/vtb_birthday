...
Window_CakeList.prototype.initialize = function(s){
    var message_window = SceneManager._scene._messageWindow;
    var x = message_window.x;
    var y = message_window.y;
    var width = message_window.width;
    var height = message_window.height;
